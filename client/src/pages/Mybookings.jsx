...
const Mybookings = () => {
    ...
    return (
        ...
        reservations in one place. Plan your trips seamlessely with just  a few Clicks ' align='left' />
                     ...
                     border-b border-gray-300 py-6 first:border-t '>
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                             <div className='flex items-center gap-2'>
                                <p className={`h-3 w-3 rounded-full ${booking.isPaid? "bg-green-500" : "bg-red-500"}`}></p>
