                ...
                <table className='w-full'>
                    <thead className='bg-gray-50'>
                        <tr>
                            ...
                            <th className='py-3 px-4 text-gray-800 font-medium text-center'>Payment Statua</th>
                        </tr>
                    </thead>
                    <tbody className='text-sm'>
                        {dashBoardData.bookings.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className='px-3 py-4 text-center text-gray-700 border-t border-gray-300'>
                                    $ {item.totalPrice}
                                </td>
