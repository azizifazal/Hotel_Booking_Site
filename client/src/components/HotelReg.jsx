      ...
      <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
          ...
          <div className='w-full mt-4'>
            ...
            <input type="text" name="" id="name"  placeholder='type here' required className='border border-gray-200 
          ...
          <div className='w-full mt-4'>
            ...
            <input type="text" name="" id="contact"  placeholder='type here' required className='border border-gray-200 
            rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light'/>
          ...
          <div className='w-full mt-4'>
            ...
            <input type="text" name="" id="address"  placeholder='type here' required className='border border-gray-200 
            rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light'/>
            
          </div>
          {/*  Drop down*/}
          <div className='w-full mt-4 max-w-40 mr-auto'>
          ...
          <button className='bg-indigo-50 hover:bg-indigo-600 transition-all
